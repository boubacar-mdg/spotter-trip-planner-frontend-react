        ...
        <div className="text-center">
          ...
          >
            <motion.button
              ...
              className="flex gap-3 items-center justify-center bg-[#2A5EF6] text-white hover:opacity-90 font-medium rounded-lg text-[11px] lg:text-[13px] px-4 py-3 focus:outline-none"
            >
              Return to home page
            </motion.button>
          </Link>
